...
DEFAULT_MANUAL_DRIVING_REWARD = 0.10
...
if __name__ == '__main__':
    ...
    parser.add_argument("--onnx", type=str, default='./yolov5l_6_0_op11_rossac.onnx', help='onnx weights path for intermediate stage')
